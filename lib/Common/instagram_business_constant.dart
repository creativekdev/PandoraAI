class InstagramBusinessConstant {
  static InstagramBusinessConstant? _instance;

  static InstagramBusinessConstant get instance {
    _instance ??= InstagramBusinessConstant._init();
    return _instance!;
  }

  InstagramBusinessConstant._init();
