...
import 'package:cartoonizer/croppy/src/utils/path.dart' as vg;
...
class CroppableImageData extends Equatable {
  ...
  /// image.
  Matrix4 get translatedBaseTransformations => translateTransformation(baseTransformations.matrix);

  /// The total transformation applied to the image.
  Matrix4 get totalImageTransform => translatedBaseTransformations * currentImageTransform * imageTransform;
  ...
  Quad2 get transformedImageQuad => originalImageQuad.transform(totalImageTransform);
  ...
  CroppableImageData copyWith({
    ...
    return CroppableImageData(
      ...
      currentImageTransform: currentImageTransform ?? this.currentImageTransform,
  ...
  static CroppableImageData? lerp(
    ...
    return CroppableImageData(
      ...
      currentImageTransform: lerpMatrix4(a.currentImageTransform, b.currentImageTransform, t),
    );
  }
