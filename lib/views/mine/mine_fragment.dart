            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  Container(height: $(12)),
                  ImageTextBarWidget(S
                      .of(context)
                      .recently, Images.ic_recently, true, color: Color(0xfff95f5f)).intoGestureDetector(onTap: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                  ...
                  ImageTextBarWidget(S
                      .of(context)
                      .share_app, ImagesConstant.ic_share_app, true).intoGestureDetector(onTap: () async {
                  ...
                  line(context),
                  ImageTextBarWidget(Platform.isAndroid ? S
                      .of(context)
                      .rate_us1 : S
                      .of(context)
                      .rate_us, ImagesConstant.ic_rate_us, true).intoGestureDetector(
                    onTap: () async {
                      AppDelegate.instance
                          .getManager<ThirdpartManager>()
                          .adsHolder
                  ...
                  line(context),
                  ImageTextBarWidget((userManager.user?.isReferred ?? false) ? S
                      .of(context)
                      .invited_code : S
                      .of(context)
                      .input_invited_code, Images.ic_ref_code, true)
                      .intoGestureDetector(
                    onTap: () {
                  ...
                  ImageTextBarWidget(S
                      .of(context)
                      .premium, Images.ic_premium, true).intoGestureDetector(onTap: () {
                    AppDelegate.instance
                        .getManager<ThirdpartManager>()
                        .adsHolder
                        .ignore = true;
                  ...
                  ImageTextBarWidget(S
                      .of(context)
                      .settings, Images.ic_settings, true).intoGestureDetector(
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        TitleTextWidget(S
                            .of(context)
                            .connect_with_us, ColorConstant.BtnTextColor, FontWeight.w500, 12.sp),
                        SizedBox(width: 3.w),
                        Expanded(
                          child: Divider(
                            color: ColorConstant.DividerColor,
