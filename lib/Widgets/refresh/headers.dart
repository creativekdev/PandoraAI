...
class CartoonizerMaterialHeader extends Header {
  ...
  CartoonizerMaterialHeader({
    ...
    bool enableHapticFeedback = false,
          ...
          float: true,
          extent: Platform.isAndroid ? 125.0 : 150,
          triggerDistance: Platform.isAndroid ? 125.0 : 150,
  ...
  Widget contentBuilder(BuildContext context, RefreshMode refreshState, double pulledExtent, double refreshTriggerPullDistance, double refreshIndicatorExtent,
    ...
    linkNotifier.contentBuilder(
        context, refreshState, pulledExtent, refreshTriggerPullDistance, refreshIndicatorExtent, axisDirection, float, completeDuration, enableInfiniteRefresh, success, noMore);
