...
class RecentEffectModel {
  ...
  RecentEffectModel.fromJson(Map<String, dynamic> json) {
    ...
    effectModel = EffectModel.fromCacheJson(json['effectModel']);
  }

  Map<String, dynamic> toJson() {
    final data = <String, dynamic>{};
    data['lastTime'] = lastTime;
    data['effectModel'] = effectModel.toJson();
    return data;
  }
}
...
extension EffectModelEx on EffectModel {
  String getShownUrl({int? pos}) {
    switch (key) {
      case 'transform':
        return "https://d35b8pv2lrtup8.cloudfront.net/assets/video/${pos ?? key}.webp";
      default:
