...
const _adjustDir = 'adjustDir/';
const _removeBgDir = 'removeBgDir/';
...
class StorageOperator {
  ...
  Directory get adjustDir => Directory('$_mainPath$_adjustDir');

  Directory get removeBgDir => Directory('$_mainPath$_removeBgDir');
