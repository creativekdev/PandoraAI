    ...
    showDialog<bool>(
        ...
        builder: (_) => Column(
              ...
              children: [
                ...
                SizedBox(height: $(16)),
                TitleTextWidget(
                  type.getContent(context, 'Cartoonize'),
                  ColorConstant.White,
                  FontWeight.w500,
                  $(13),
                  maxLines: 100,
      ...
      if (value == null) {
        ...
        switch (type) {
          case AccountLimitType.guest:
            userManager.doOnLogin(context,
                logPreLoginAction: 'cartoonize_generate_limit',
                callback: () {
                  Navigator.of(context).pop();
                },
                autoExec: true,
          ...
          case AccountLimitType.normal:
            userManager.doOnLogin(context,
                logPreLoginAction: 'cartoonize_generate_limit',
                callback: () {
                  PaymentUtils.pay(context, 'cartoonize_generate_limit').then((value) {
                    Navigator.of(context).pop();
                  });
                },
                autoExec: true,
        ...
        userManager.doOnLogin(context, logPreLoginAction: 'cartoonize_generate_limit', callback: () {
