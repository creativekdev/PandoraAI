  ...
  Widget build(BuildContext context) {
    if (controller is CupertinoCroppableImageController) {
      return ValueListenableBuilder(
        valueListenable: (controller as CupertinoCroppableImageController).guideLinesVisibility,
        builder: (conetxt, isVisible, child) => _buildHandles(context, isVisible),
      );
    }
...
class _CupertinoImageRectCropHandlesPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.lineTo(size.width + handleThickness / 2, size.height + handleThickness / 2);
  ...
  @override
  bool shouldRepaint(_CupertinoImageRectCropHandlesPainter oldDelegate) => false;
}
...
class _CupertinoImageCustomCropHandlesPainter extends CustomPainter {
  ...
  @override
  bool shouldRepaint(_CupertinoImageCustomCropHandlesPainter oldDelegate) => oldDelegate.cropShape != cropShape;
}
...
class _CupertinoImageCropperFineGuidesPainter extends CustomPainter {
  ...
  @override
  bool shouldRepaint(_CupertinoImageCropperFineGuidesPainter oldDelegate) => false;
}
