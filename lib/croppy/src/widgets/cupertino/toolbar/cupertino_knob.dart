...
class CupertinoKnobButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final color = isPositive ? CupertinoTheme.of(context).primaryColor : CupertinoColors.white;
...
class _CupertinoKnobProgressPainter extends CustomPainter {
  ...
  @override
  bool shouldRepaint(_CupertinoKnobProgressPainter oldDelegate) => oldDelegate.value != value || oldDelegate.primaryColor != primaryColor;
}
