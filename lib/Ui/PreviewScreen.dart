...
class PreviewScreen extends StatefulWidget {
  ...
  const PreviewScreen({Key? key, required this.image, required this.url, required this.algoName}) : super(key: key);
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      GestureDetector(
                        onTap: () async {
                          final result = await ImageGallerySaver.saveImage(base64Decode(widget.image), quality: 100, name: "Cartoonizer_${DateTime.now().millisecondsSinceEpoch}");
                      ...
                      children: [
                              ...
                              children: [
                                GestureDetector(
                                  onTap: () async {
                                    ...
                                    params.add(JsonValueModel("algo", widget.algoName));
                                    params.sort();
                                    ...
                                    final rateResponse = await post(Uri.parse('https://socialbook.io/api/tool/matting/evaluate'),
                        ...
                        FutureBuilder(
                          ...
                          builder: (context, snapshot) {
                            return Visibility(
                              visible: (!(snapshot.data != null ? snapshot.data as bool : true) || isLoading),
                                  ...
                                  Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                      ...
                                      builder: (context) => LoginScreen(),
                                        ...
                                        isLoading = (value != null) ? value as bool : true;
                                      }))
                                },
