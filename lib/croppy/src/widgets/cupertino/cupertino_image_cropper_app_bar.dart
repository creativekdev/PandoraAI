...
class CupertinoImageCropperAppBar extends StatelessWidget implements ObstructingPreferredSizeWidget {
  ...
  Widget _buildAppBarButtons(BuildContext context) {
    return Row(
      children: [
        ...
        const Spacer(),
        if (controller is CupertinoCroppableImageController && (controller as CupertinoCroppableImageController).allowedAspectRatios.length > 1)
          ValueListenableBuilder(
            ...
            builder: (context, toolbar, _) => CupertinoButton(
              onPressed: () {
                ...
                final _controller = controller as CupertinoCroppableImageController;
              ...
              child: CupertinoAspectRatioIcon(
                color: toolbar == CupertinoCroppableImageToolbar.aspectRatio ? CupertinoTheme.of(context).primaryColor : CupertinoColors.systemGrey2,
                size: 24.0,
              ),
            ),
          ),
              ...
              Center(
                child: ValueListenableBuilder(
                  ...
                  child: CupertinoButton(
                    ...
                    child: Text(
                      'RESET',
                      style: CupertinoTheme.of(context).textTheme.navActionTextStyle.copyWith(fontSize: 14.0),
                    ),
                  ),
                ),
              ),
