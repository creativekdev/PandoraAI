...
class CupertinoImageCropperBottomAppBar extends StatelessWidget implements ObstructingPreferredSizeWidget {
        ...
        FutureButton(
          ...
          builder: (context, onTap) => CupertinoButton(
            ...
            child: Text(
              'Done',
              style: TextStyle(
                color: onTap != null ? primaryColor : primaryColor.withOpacity(0.5),
              ),
            ),
          ),
        ),
