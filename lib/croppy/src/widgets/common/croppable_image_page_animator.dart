...
class CroppableImagePageAnimator extends StatefulWidget {
  ...
  /// Hero animation.
  static CroppableImagePageAnimatorState? of(BuildContext context) => context.findAncestorStateOfType<CroppableImagePageAnimatorState>();

  @override
  State<CroppableImagePageAnimator> createState() => CroppableImagePageAnimatorState();
}

class CroppableImagePageAnimatorState extends State<CroppableImagePageAnimator> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    if (widget.heroTag != null) {
      WidgetsBinding.instance.addPostFrameCallback((_) {
        final transitionDuration = ModalRoute.of(context)?.transitionDuration ?? widget.duration;
