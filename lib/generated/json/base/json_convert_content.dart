...
class JsonConvert {
  static final Map<String, JsonConvertFunction> convertFuncMap = {
    ...
    (DiscoveryCommentListEntity).toString():
        DiscoveryCommentListEntity.fromJson,
    ...
    (PlatformConnectionCoreUser).toString():
        PlatformConnectionCoreUser.fromJson,
    ...
    (PrintProductDataRowsFeaturedImage).toString():
        PrintProductDataRowsFeaturedImage.fromJson,
    (PrintProductDataRowsVariants).toString():
        PrintProductDataRowsVariants.fromJson,
    (PrintProductDataRowsVariantsEdges).toString():
        PrintProductDataRowsVariantsEdges.fromJson,
    (PrintProductDataRowsVariantsEdgesNode).toString():
    ...
    (ShippingMethodShippingRateData).toString():
        ShippingMethodShippingRateData.fromJson,
    (ShippingMethodShippingRateDataFixedAmount).toString():
        ShippingMethodShippingRateDataFixedAmount.fromJson,
  ...
  static M? _getListChildType<M>(List<Map<String, dynamic>> data) {
    if (<AdConfigEntity>[] is M) {
      return data
          .map<AdConfigEntity>(
              (Map<String, dynamic> e) => AdConfigEntity.fromJson(e))
          .toList() as M;
    }
    if (<AiDrawResultEntity>[] is M) {
      return data
          .map<AiDrawResultEntity>(
              (Map<String, dynamic> e) => AiDrawResultEntity.fromJson(e))
          .toList() as M;
    }
    if (<AnotherMeResultEntity>[] is M) {
      return data
          .map<AnotherMeResultEntity>(
              (Map<String, dynamic> e) => AnotherMeResultEntity.fromJson(e))
          .toList() as M;
    }
    if (<AppFeatureEntity>[] is M) {
      return data
          .map<AppFeatureEntity>(
              (Map<String, dynamic> e) => AppFeatureEntity.fromJson(e))
          .toList() as M;
    }
    if (<AppFeaturePayload>[] is M) {
      return data
          .map<AppFeaturePayload>(
              (Map<String, dynamic> e) => AppFeaturePayload.fromJson(e))
          .toList() as M;
    }
    if (<AvatarAiListEntity>[] is M) {
      return data
          .map<AvatarAiListEntity>(
              (Map<String, dynamic> e) => AvatarAiListEntity.fromJson(e))
          .toList() as M;
    }
    if (<AvatarChildEntity>[] is M) {
      return data
          .map<AvatarChildEntity>(
              (Map<String, dynamic> e) => AvatarChildEntity.fromJson(e))
          .toList() as M;
    }
    if (<AvatarConfigEntity>[] is M) {
      return data
          .map<AvatarConfigEntity>(
              (Map<String, dynamic> e) => AvatarConfigEntity.fromJson(e))
          .toList() as M;
    }
    if (<AvatarConfigData>[] is M) {
      return data
          .map<AvatarConfigData>(
              (Map<String, dynamic> e) => AvatarConfigData.fromJson(e))
          .toList() as M;
    }
    if (<CropRecordEntity>[] is M) {
      return data
          .map<CropRecordEntity>(
              (Map<String, dynamic> e) => CropRecordEntity.fromJson(e))
          .toList() as M;
    }
    if (<DailyLimitRuleEntity>[] is M) {
      return data
          .map<DailyLimitRuleEntity>(
              (Map<String, dynamic> e) => DailyLimitRuleEntity.fromJson(e))
          .toList() as M;
    }
    if (<VIPPlanDetail>[] is M) {
      return data
          .map<VIPPlanDetail>(
              (Map<String, dynamic> e) => VIPPlanDetail.fromJson(e))
          .toList() as M;
    }
    if (<DiscoveryCommentListEntity>[] is M) {
      return data
          .map<DiscoveryCommentListEntity>((Map<String, dynamic> e) =>
              DiscoveryCommentListEntity.fromJson(e))
          .toList() as M;
    }
    if (<DiscoveryListEntity>[] is M) {
      return data
          .map<DiscoveryListEntity>(
              (Map<String, dynamic> e) => DiscoveryListEntity.fromJson(e))
          .toList() as M;
    }
    if (<DiscoveryResource>[] is M) {
      return data
          .map<DiscoveryResource>(
              (Map<String, dynamic> e) => DiscoveryResource.fromJson(e))
          .toList() as M;
    }
    if (<GenerateLimitEntity>[] is M) {
      return data
          .map<GenerateLimitEntity>(
              (Map<String, dynamic> e) => GenerateLimitEntity.fromJson(e))
          .toList() as M;
    }
    if (<HomeCardEntity>[] is M) {
      return data
          .map<HomeCardEntity>(
              (Map<String, dynamic> e) => HomeCardEntity.fromJson(e))
          .toList() as M;
    }
    if (<MetagramPageEntity>[] is M) {
      return data
          .map<MetagramPageEntity>(
              (Map<String, dynamic> e) => MetagramPageEntity.fromJson(e))
          .toList() as M;
    }
    if (<SocialPostPageEntity>[] is M) {
      return data
          .map<SocialPostPageEntity>(
              (Map<String, dynamic> e) => SocialPostPageEntity.fromJson(e))
          .toList() as M;
    }
    if (<MetagramItemEntity>[] is M) {
      return data
          .map<MetagramItemEntity>(
              (Map<String, dynamic> e) => MetagramItemEntity.fromJson(e))
          .toList() as M;
    }
    if (<MsgCountEntity>[] is M) {
      return data
          .map<MsgCountEntity>(
              (Map<String, dynamic> e) => MsgCountEntity.fromJson(e))
          .toList() as M;
    }
    if (<MsgEntity>[] is M) {
      return data
          .map<MsgEntity>((Map<String, dynamic> e) => MsgEntity.fromJson(e))
          .toList() as M;
    }
    if (<MsgDiscoveryEntity>[] is M) {
      return data
          .map<MsgDiscoveryEntity>(
              (Map<String, dynamic> e) => MsgDiscoveryEntity.fromJson(e))
          .toList() as M;
    }
    if (<PageEntity>[] is M) {
      return data
          .map<PageEntity>((Map<String, dynamic> e) => PageEntity.fromJson(e))
          .toList() as M;
    }
    if (<MsgPageEntity>[] is M) {
      return data
          .map<MsgPageEntity>(
              (Map<String, dynamic> e) => MsgPageEntity.fromJson(e))
          .toList() as M;
    }
    if (<PayPlanEntity>[] is M) {
      return data
          .map<PayPlanEntity>(
              (Map<String, dynamic> e) => PayPlanEntity.fromJson(e))
          .toList() as M;
    }
    if (<PlatformConnectionEntity>[] is M) {
      return data
          .map<PlatformConnectionEntity>(
              (Map<String, dynamic> e) => PlatformConnectionEntity.fromJson(e))
          .toList() as M;
    }
    if (<PlatformConnectionCoreUser>[] is M) {
      return data
          .map<PlatformConnectionCoreUser>((Map<String, dynamic> e) =>
              PlatformConnectionCoreUser.fromJson(e))
          .toList() as M;
    }
    if (<PrintOptionEntity>[] is M) {
      return data
          .map<PrintOptionEntity>(
              (Map<String, dynamic> e) => PrintOptionEntity.fromJson(e))
          .toList() as M;
    }
    if (<PrintOptionData>[] is M) {
      return data
          .map<PrintOptionData>(
              (Map<String, dynamic> e) => PrintOptionData.fromJson(e))
          .toList() as M;
    }
    if (<PrintOptionDataCanvaSize>[] is M) {
      return data
          .map<PrintOptionDataCanvaSize>(
              (Map<String, dynamic> e) => PrintOptionDataCanvaSize.fromJson(e))
          .toList() as M;
    }
    if (<PrintOptionDataS3Files>[] is M) {
      return data
          .map<PrintOptionDataS3Files>(
              (Map<String, dynamic> e) => PrintOptionDataS3Files.fromJson(e))
          .toList() as M;
    }
    if (<PrintProductEntity>[] is M) {
      return data
          .map<PrintProductEntity>(
              (Map<String, dynamic> e) => PrintProductEntity.fromJson(e))
          .toList() as M;
    }
    if (<PrintProductData>[] is M) {
      return data
          .map<PrintProductData>(
              (Map<String, dynamic> e) => PrintProductData.fromJson(e))
          .toList() as M;
    }
    if (<PrintProductDataRows>[] is M) {
      return data
          .map<PrintProductDataRows>(
              (Map<String, dynamic> e) => PrintProductDataRows.fromJson(e))
          .toList() as M;
    }
    if (<PrintProductDataRowsFeaturedImage>[] is M) {
      return data
          .map<PrintProductDataRowsFeaturedImage>((Map<String, dynamic> e) =>
              PrintProductDataRowsFeaturedImage.fromJson(e))
          .toList() as M;
    }
    if (<PrintProductDataRowsVariants>[] is M) {
      return data
          .map<PrintProductDataRowsVariants>((Map<String, dynamic> e) =>
              PrintProductDataRowsVariants.fromJson(e))
          .toList() as M;
    }
    if (<PrintProductDataRowsVariantsEdges>[] is M) {
      return data
          .map<PrintProductDataRowsVariantsEdges>((Map<String, dynamic> e) =>
              PrintProductDataRowsVariantsEdges.fromJson(e))
          .toList() as M;
    }
    if (<PrintProductDataRowsVariantsEdgesNode>[] is M) {
      return data
          .map<PrintProductDataRowsVariantsEdgesNode>(
              (Map<String, dynamic> e) =>
                  PrintProductDataRowsVariantsEdgesNode.fromJson(e))
          .toList() as M;
    }
    if (<PrintProductDataRowsVariantsEdgesNodeSelectedOptions>[] is M) {
      return data
          .map<PrintProductDataRowsVariantsEdgesNodeSelectedOptions>(
              (Map<String, dynamic> e) =>
                  PrintProductDataRowsVariantsEdgesNodeSelectedOptions.fromJson(
                      e))
          .toList() as M;
    ...
    if (<PushExtraEntity>[] is M) {
      return data
          .map<PushExtraEntity>(
              (Map<String, dynamic> e) => PushExtraEntity.fromJson(e))
          .toList() as M;
    }
    if (<PushModuleExtraEntity>[] is M) {
      return data
          .map<PushModuleExtraEntity>(
              (Map<String, dynamic> e) => PushModuleExtraEntity.fromJson(e))
          .toList() as M;
    }
    if (<RateConfigEntity>[] is M) {
      return data
          .map<RateConfigEntity>(
              (Map<String, dynamic> e) => RateConfigEntity.fromJson(e))
          .toList() as M;
    }
    if (<RecentEffectModel>[] is M) {
      return data
          .map<RecentEffectModel>(
              (Map<String, dynamic> e) => RecentEffectModel.fromJson(e))
          .toList() as M;
    }
    if (<RecentEffectItem>[] is M) {
      return data
          .map<RecentEffectItem>(
              (Map<String, dynamic> e) => RecentEffectItem.fromJson(e))
          .toList() as M;
    }
    if (<RecentMetaverseEntity>[] is M) {
      return data
          .map<RecentMetaverseEntity>(
              (Map<String, dynamic> e) => RecentMetaverseEntity.fromJson(e))
          .toList() as M;
    }
    if (<RecentGroundEntity>[] is M) {
      return data
          .map<RecentGroundEntity>(
              (Map<String, dynamic> e) => RecentGroundEntity.fromJson(e))
          .toList() as M;
    }
    if (<ShippingMethodEntity>[] is M) {
      return data
          .map<ShippingMethodEntity>(
              (Map<String, dynamic> e) => ShippingMethodEntity.fromJson(e))
          .toList() as M;
    }
    if (<ShippingMethodShippingRateData>[] is M) {
      return data
          .map<ShippingMethodShippingRateData>((Map<String, dynamic> e) =>
              ShippingMethodShippingRateData.fromJson(e))
          .toList() as M;
    }
    if (<ShippingMethodShippingRateDataFixedAmount>[] is M) {
      return data
          .map<ShippingMethodShippingRateDataFixedAmount>(
              (Map<String, dynamic> e) =>
                  ShippingMethodShippingRateDataFixedAmount.fromJson(e))
          .toList() as M;
    }
    if (<StyleMorphResultEntity>[] is M) {
      return data
          .map<StyleMorphResultEntity>(
              (Map<String, dynamic> e) => StyleMorphResultEntity.fromJson(e))
          .toList() as M;
    }
    if (<Txt2imgResultEntity>[] is M) {
      return data
          .map<Txt2imgResultEntity>(
              (Map<String, dynamic> e) => Txt2imgResultEntity.fromJson(e))
          .toList() as M;
    }
    if (<Txt2imgStyleEntity>[] is M) {
      return data
          .map<Txt2imgStyleEntity>(
              (Map<String, dynamic> e) => Txt2imgStyleEntity.fromJson(e))
          .toList() as M;
    }
    if (<UploadRecordEntity>[] is M) {
      return data
          .map<UploadRecordEntity>(
              (Map<String, dynamic> e) => UploadRecordEntity.fromJson(e))
          .toList() as M;
    }
    if (<UserRefLinkEntity>[] is M) {
      return data
          .map<UserRefLinkEntity>(
              (Map<String, dynamic> e) => UserRefLinkEntity.fromJson(e))
          .toList() as M;
    }
