...
class CupertinoImageTransformationToolbar extends StatefulWidget {
  ...
  @override
  State<CupertinoImageTransformationToolbar> createState() => _CupertinoImageTransformationToolbarState();
}
...
class _CupertinoImageTransformationToolbarState extends State<CupertinoImageTransformationToolbar> {
  ...
  void initState() {
    ...
    _knobs = [
      if (widget.controller.isTransformationEnabled(Transformation.rotateZ)) _Knob.rotateZ,
      if (widget.controller.isTransformationEnabled(Transformation.rotateX)) _Knob.rotateX,
      if (widget.controller.isTransformationEnabled(Transformation.rotateY)) _Knob.rotateY,
    ];
...
class _CupertinoImageTransformationToolbarKnobs extends StatefulWidget {
  ...
  @override
  State<_CupertinoImageTransformationToolbarKnobs> createState() => _CupertinoImageTransformationToolbarKnobsState();
}

class _CupertinoImageTransformationToolbarKnobsState extends State<_CupertinoImageTransformationToolbarKnobs> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Transform.translate(
      ...
      child: Row(
        ...
        children: widget.children.map((v) => Padding(padding: const EdgeInsets.symmetric(horizontal: 8.0), child: v)).toList(),
      ),
    );
  }
}
