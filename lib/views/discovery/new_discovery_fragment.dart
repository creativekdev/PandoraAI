...
import 'package:cartoonizer/views/discovery/new_discovery_list_controller.dart';
...
class NewDiscoveryFragment extends StatefulWidget {
  AppTabId tabId;
  ...
  @override
  State<NewDiscoveryFragment> createState() => NewDiscoveryFragmentState();
}

class NewDiscoveryFragmentState extends AppState<NewDiscoveryFragment> with AutomaticKeepAliveClientMixin, AppTabState, TickerProviderStateMixin {
  UserManager userManager = AppDelegate.instance.getManager();
  CacheManager cacheManager = AppDelegate.instance.getManager();
  late NewDiscoveryListController listController;
  ...
  void initState() {
    ...
    initAnimator();
    listController = Get.put(NewDiscoveryListController(
      ticker: this,
      tabId: widget.tabId,
    ));
  }
  ...
  Widget buildWidget(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder<NewDiscoveryListController>(
        init: listController,
  ...
  Widget buildHeader(NewDiscoveryListController listController) {
    return ClipRect(
  ...
  Widget buildRefreshList(NewDiscoveryListController listController) {
