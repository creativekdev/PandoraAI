...
Future<CropImageResult> cropImageBilinear(
  ...
  (int, int, int, int) getBilinearlyInterpolatedOriginalImagePixel(
    ...
    final r = (r1 * (x2 - x) * (y2 - y)) + (r2 * (x - x1) * (y2 - y)) + (r3 * (x2 - x) * (y - y1)) + (r4 * (x - x1) * (y - y1));
    final g = (g1 * (x2 - x) * (y2 - y)) + (g2 * (x - x1) * (y2 - y)) + (g3 * (x2 - x) * (y - y1)) + (g4 * (x - x1) * (y - y1));
    final b = (b1 * (x2 - x) * (y2 - y)) + (b2 * (x - x1) * (y2 - y)) + (b3 * (x2 - x) * (y - y1)) + (b4 * (x - x1) * (y - y1));
    final a = (a1 * (x2 - x) * (y2 - y)) + (a2 * (x - x1) * (y2 - y)) + (a3 * (x2 - x) * (y - y1)) + (a4 * (x - x1) * (y - y1));
