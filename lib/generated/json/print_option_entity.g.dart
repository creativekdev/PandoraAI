...
PrintOptionEntity $PrintOptionEntityFromJson(Map<String, dynamic> json) {
	...
	final List<PrintOptionData>? data = jsonConvert.convertListNotNull<PrintOptionData>(json['data']);
	if (data != null) {
...
PrintOptionData $PrintOptionDataFromJson(Map<String, dynamic> json) {
	...
	final dynamic thumbnailLarge = jsonConvert.convert<dynamic>(json['thumbnail_large']);
	...
	final PrintOptionDataCanvaSize? canvaSize = jsonConvert.convert<PrintOptionDataCanvaSize>(json['canva_size']);
	if (canvaSize != null) {
	...
	final dynamic mediakitChannel = jsonConvert.convert<dynamic>(json['mediakit_channel']);
	...
	final String? shopifyProductId = jsonConvert.convert<String>(json['shopify_product_id']);
	...
	final PrintOptionDataS3Files? s3Files = jsonConvert.convert<PrintOptionDataS3Files>(json['s3_files']);
	if (s3Files != null) {
...
PrintOptionDataCanvaSize $PrintOptionDataCanvaSizeFromJson(Map<String, dynamic> json) {
	final PrintOptionDataCanvaSize printOptionDataCanvaSize = PrintOptionDataCanvaSize();
...
Map<String, dynamic> $PrintOptionDataCanvaSizeToJson(PrintOptionDataCanvaSize entity) {
	final Map<String, dynamic> data = <String, dynamic>{};
...
PrintOptionDataS3Files $PrintOptionDataS3FilesFromJson(Map<String, dynamic> json) {
	final PrintOptionDataS3Files printOptionDataS3Files = PrintOptionDataS3Files();
	final String? tHUMBNAIL = jsonConvert.convert<String>(json['THUMBNAIL']);
	if (tHUMBNAIL != null) {
...
Map<String, dynamic> $PrintOptionDataS3FilesToJson(PrintOptionDataS3Files entity) {
	final Map<String, dynamic> data = <String, dynamic>{};
	data['THUMBNAIL'] = entity.tHUMBNAIL;
	data['THUMBNAIL_LARGE'] = entity.thumbnailLarge;
	return data;
