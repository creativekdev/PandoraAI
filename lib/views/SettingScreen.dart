                            ...
                            Expanded(
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    TitleTextWidget((snapshot.hasData) ? (snapshot.data as UserModel).email : "", Colors.white, FontWeight.w500, 12.sp, align: TextAlign.start),
                                    TitleTextWidget((snapshot.hasData) ? (snapshot.data as UserModel).name : "", Colors.white, FontWeight.w400, 12.sp, align: TextAlign.start),
                                  ],
                                ),
                              ),
                            ),
                ...
                if (((snapshot.data != null ? snapshot.data as bool : true) || isLoading)) {
                  return FutureBuilder(
                      ...
                      builder: (context, snapshot) {
                        ...
                        return ImageTextBarWidget(StringConstant.change_password, ImagesConstant.ic_change_password, false).intoGestureDetector(onTap: () {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
