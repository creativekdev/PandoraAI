                    ...
                    Transform.translate(
                      ...
                      child: Text(
                        ...
                        style: labelStyle?.copyWith(
                          color: value.abs() > epsilon ? theme.colorScheme.primary : null,
                        ),
                      ),
                    ),
...
class _MaterialRotationSliderPainter extends CustomPainter {
  ...
  @override
  bool shouldRepaint(_MaterialRotationSliderPainter oldDelegate) => primaryColor != oldDelegate.primaryColor || value != oldDelegate.value;
}
