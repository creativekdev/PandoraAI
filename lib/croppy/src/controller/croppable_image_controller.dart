...
abstract class BaseCroppableImageController extends ChangeNotifier {
  ...
  Matrix4 getMatrixForBaseTransformations(
    ...
    final newTransform = data.copyWith(baseTransformations: newBaseTransformations).translatedBaseTransformations;
...
abstract class CroppableImageController extends BaseCroppableImageController
    with PanAndScaleTransformation, ResizeTransformation, StraightenAndPerspectiveTransformation, RotateTransformation, MirrorTransformation {
...
abstract class CroppableImageControllerWithMixins extends CroppableImageController with AspectRatioMixin, ResizeStaticLayoutMixin, ViewportScaleComputerMixin {
