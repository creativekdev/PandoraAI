...
class _InstaLikeButtonState extends State<InstaLikeButton> with TickerProviderStateMixin {
  ...
  AnimatedOpacity buildAnimatedIcon() => AnimatedOpacity(
        ...
        child: Icon(widget.icon, size: _iconSizeAnimation.value, color: widget.iconColor),
      );
